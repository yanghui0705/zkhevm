  ...
  <div class="sys-page">
    ...
    <div class="page-content">
      ...
      <app-section title="使用方法" v-once>
        <div class="sys-article">
          <h2>创建及配置语言包</h2>
          <p>在<code>src/lang</code>下，创建语言包对应的语言文件，以key-value格式进行存储。保证在不同文件中key值相同。具体可参考<code>src/lang</code>中的对应代码。以下为示例
          </p>
        ...
        <div class="sys-article">
          <h2>设置默认语言</h2>
          <p>在<code>src/util/i18n.js</code>中修改如下代码。需要注意，locale及fallbackLocale的值需要相同，并且与<code>src/lang/index.js</code>中的Key值保证一致。
          </p>
          <pre v-pre class="sys-pre"><code>
