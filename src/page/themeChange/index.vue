  ...
  <div class="sys-page">
    ...
    <div class="page-content">
      ...
      <app-section title="切换主题颜色">
        <app-notes><p>
          本项目使用sass编写，所以变更主题方式相对简单。因时间原因，第二套主题(grenn)仅为功能示例。由于切换主题功能原理的限制，该功能当前仅能用于生产环境，开发环境时需要进行手动修改引入的主题文件。主题切换详细实现原理请查看：<a
          href="http://blog.csdn.net/harsima/article/details/78934405"> Vue + ElementUI 手撸后台管理网站基本框架(四)主题切换</a></p>
        </app-notes>
...
// 直接在按钮处或页面加载时直接使用setTheme()方法即可
          ...
          <p>基于上面的原因，如果你需要查看打包后的主题是否正确，切换功能是否能够正常使用，那么你需要先将工程打包一次，然后将生成的主题文件放置到项目根目录中的<code>static</code>文件夹，然后在<code>main.dev.js</code>中去掉所有的主题引用，在<code>index.html</code>替换成打包后的html文件。期间请保证文件目录正确。
          </p>
        </div>
        <div class="sys-article">
